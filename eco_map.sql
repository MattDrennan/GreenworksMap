...
CREATE TABLE `greenworks_locations` (
  ...
  UNIQUE KEY `unique_location` (`Sub_PillarID`,`Street_address`,`Descr`),
...
-- Dump completed on 2021-11-30 23:17:07
